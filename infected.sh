...
echo -e "$red                        ➡$cyan [\e[92m3\e[96m] Follow"
echo -e "$red                        ➡$cyan [\e[92m4\e[96m] More"
echo -e "$red                        ➡$cyan [\e[92m5\e[96m] Chat"
echo -e "$red                        ➡$cyan [\e[92m6\e[96m] Exit"
echo " "
echo " "
...
while git clone https://github.com/oyononsanity/Infected 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
